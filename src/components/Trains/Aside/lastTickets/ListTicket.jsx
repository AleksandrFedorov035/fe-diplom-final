    ...
    return (
        <div className="listTicket">
            ...
            <div className="listTicket-footer">
                <div className="icons">
                    {hasWifi && <img src="src/assets/images/trains-types/wifi.svg" alt="wifi" />}
                    {isExpress && <img src="src/assets/images/trains-types/rocket.svg" alt="rocket" />}
                    {hasFirstClass && <img src="src/assets/images/cap.svg" alt="cap" />}
                </div>
